...
Тогда
\begin{multline*}
J \cdot \eps^\alpha = \int_0^{\eps} \big( a(s + z, \bar{v} + z)^\alpha + a(t - z, \bar{v} + z)^\alpha
- a(\frac{s - t}{2} + z, \bar{v} + z)^\alpha - a(\frac{t - s}{2} - z, \bar{v} + z)^\alpha \big) dz \\
\le \int_0^{\eps} \big( a(s + z, \bar{v} + z) + a(t - z, \bar{v} + z) + 2 \delta
