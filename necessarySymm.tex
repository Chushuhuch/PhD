...
\begin{lm}
Если для функции $a \in C([-1, 1] \times \Real_+)$ выполнено соотношение (\ref{almostConvex}), то она четна по первому аргументу.
\end{lm}
...
где $w_\rho(z)$ --- усредняющее ядро с радиусом $\rho$.
Тогда 
\begin{multline*}
