...
\begin{center}
\begin{tabular}{l|l|l} 
\multirow{2}{*}{$u(-1)<u_0$} & $m_j$ четно   & $y^*=1-\sum\limits_{k=1}^{m_j} (-1)^k y_k^j$ \\
                             & $m_j$ нечетно & $y^*=-\sum\limits_{k=1}^{m_j} (-1)^k y_k^j$ \\ \hline
\multirow{2}{*}{$u(-1)>u_0$} & $m_j$ четно   & $y^*=-1+\sum\limits_{k=1}^{m_j} (-1)^k y_k^j$ \\
                             & $m_j$ нечетно & $y^*=\sum\limits_{k=1}^{m_j} (-1)^k y_k^j$ \\ 
\end{tabular}
\end{center}
...
$$T:=\sum_{k=1}^m b_k F( \frac{ a(y_k, v) }{b_k} ) \ge F\Big( \frac{ a(y^*, v) }{ \sum_{k=1}^m b_k  } \Big) \sum_{k=1}^m b_k$$
