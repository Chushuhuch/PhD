...
\textbf{1.} For any $-1 \le t_1 \le t_2 \le \ldots \le t_n \le 1$
...
\textbf{2.} The proof of this part is trivial.
\end{proof}

\begin{lm}
\label{periodicity}
\textbf{1.} Let $\mathfrak a$ satisfy $(\ref{almostConcave})$.
...
\textbf{2.} Let $\mathfrak a$ be even and satisfy $(\ref{almostConcave})$.
If there is $x_0 \in [-1, 1]$, such that $\mathfrak a(x_0) = 0$,
...
\textbf{2.} The periodicity of zeros of the function $\mathfrak a$ follows from its evenness and from the first assertion of the lemma.
