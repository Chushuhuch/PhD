...
Пусть функция $a(x', \cdot, u)$ чётна и удовлетворяет условию $(\ref{almostConcave})$ для всех $x'$ и $u$.
Тогда
...
Аналогично, с учётом замечаний (\ref{landesNecessaryRem}) и (\ref{landesLinearRem}), доказывается
\begin{thm}
