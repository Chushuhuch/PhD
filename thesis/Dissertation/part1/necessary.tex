...
\textbf{2.}
\mytodo{в многомерном случае рассматриваются функции .. и доказательство проходит. Боковые производные ...}
Легко видеть, что для многомерного случая можно подобрать функции аналогичные $u_1$ и $u_2$.
\end{proof}
