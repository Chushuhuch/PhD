...
\todo{зам 3 -> lm. thm 3 нормально написать. Чуть приподнять тему Ландеса.}

\todo{св-ва весов разбить. Первую лемму в следующий параграф. Остальное в виде параграфа в следующую главу.}

\todo{сразу потребовать липшицевость границы}

\todo{д-во теоремы 2 I -> J}

\todo{lm 7 -> thm. 1) для симметризации 2) для монотонной}

\todo{стр 20 + стоит в конце строки}
...
(здесь и далее $\Real_+ = [0, \infty)$ \todo{move to notations}),
