...
\mytodo{вынести перестановки}

\mytodo{сл. пол. сн. Брока --- в св-ва перестановок}
\mytodo{пофиксить оверфлоу}
\mytodo{надо будет менять название глав}
\mytodo{6, Теорема 2.4 - объяснить - где аналогичная теорема была д-на без зав-ти от $x$}
\mytodo{можно ввести обозначения: соб, лип}
\mytodo{все "интересуют нас" -> существенны}
\mytodo{предл 2 наверх. Выносить по группам тематическим. Тут теория меры.}
\mytodo{$f_\pm$ в обозначения}
\mytodo{рисунки крупнее. Два рисунка примерно на страницу. Графики жирной}
\mytodo{fix discontinuity in graphs}
\mytodo{Расписать все формулы для $B_i$}
\mytodo{В формулах для $B_i$ добавить квадратные скобки в первую строку.
Добавить звёздочку на первое нер-во и сказать, что там монотонность}
\mytodo{Рисунки с областями сделать с нумерацию с секциями}
