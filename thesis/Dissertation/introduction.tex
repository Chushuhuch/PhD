...
\todo{introduce a section with formulations of external assertions}
...
выпуклых и возрастающих по третьему аргументу, удовлетворяющих $F( \cdot, \cdot, 0 ) \equiv 0$.

Рассмотрим функционал:
\begin{equation}
\label{weighted_functional}
\IWg( u ) = \IWg( a, u ) = \int\limits_\Omega F( x', u(x), \norm{ \mathcal{D} u } ) dx,
\end{equation}
где $F \in \mathfrak{F}$,
...
и также доказываем аналогичный результат для симметричной перестановки, тем самым закрывая пробел в работе \cite{Brock}.
