\section{Доказательство неравенства (\ref{eq:to_prove_weighted}) для произвольных весов}
...
Тем самым \mytodo{тем самым или это ещё один очевидный факт?}, $\mathfrak b_{\ell}(\cdot, v) \rightrightarrows a(\cdot, v)$ для почти всех $v$.
