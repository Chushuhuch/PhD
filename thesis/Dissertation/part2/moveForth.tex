...
\bigskip
\noindent
$(H4)$ Найдется такое чётное $k$, что $a(\cdot, v)$ линейны для каждого $v$ на участках
...
Тогда найдется возрастающая последовательность весов $\mathfrak b_{\ell}$ такая, что
...
Покажем, что найдется последовательность $\alpha_j \searrow 0$, что $\mathfrak d_{\alpha_j}$ не имеет горизонтальных участков,
...
Тем самым, найдется последовательность весов $\mathfrak d_{\alpha_j} \searrow \mathfrak c$, удовлетворяющих $(H1)-(H5)$.
...
Действительно, в противном случае найдется последовательность $v_m$, для которой
...
Для каждого $m$ найдется $x_m$ такой, что
