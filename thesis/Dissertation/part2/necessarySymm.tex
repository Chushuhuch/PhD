\section{Условия, необходимые для выполнения неравенства (\ref{eq:toprove_symm})}
...
Если это так, то ввиду леммы \ref{lm:convex_even_criterion} утверждение теоремы будет следовать.
