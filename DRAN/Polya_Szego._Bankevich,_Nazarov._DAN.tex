...
В \textsection \ref{symmSection} данной работы мы устанавливаем отсутствие эффекта
...
наши результаты для этого случая, сформулированные в конце \textsection
\ref{sobolSection}, сильнее, чем в \cite{Lan}.
...
Сначала (\ref{toprovemon}) доказывается при дополнительном предположении, что
$\mathfrak{a}$ кусочно монотонна и постоянна в окрестностях ненулевых локальных
минимумов. Затем --- для кусочно монотонных функций $\mathfrak{a}$, и, наконец,
...
вначале для функций $a$, постоянных по $x$ в окрестности нуля, а затем для
общего случая.
...
Исследование выполнено в Санкт-Петербургском государственном университете.

Назаров Александр Ильич. (автор для переписки) Профессор кафедры математической
физики Математико-механического факультета Санкт-Петербургского государственного
университета.

адрес: 194064, СПб, Тихорецкий пр. 9, к.~9, кв.~33.

телефон: (812) 428-42-11 (рабочий), (812) 444-15-22 (домашний).

e-mail: al.il.nazarov@gmail.com

Банкевич Сергей Викторович. Аспирант кафедры математической
физики Математико-механического факультета Санкт-Петербургского государственного
университета.

адрес: 196066, СПб, Авиационная 9, кв.~3.

телефон: (812) 708-53-79 (домашний).

e-mail: Sergey.Bankevich@gmail.com

\newpage

УДК 517.97 \qquad математика

\begin{center}
{\bf
Об обобщении неравенства Пойа-Сеге для одномерных функционалов

С.~В.~Банкевич \qquad А.~И.~Назаров

Аннотация}
\end{center}

Рассматривается неравенство типа Пойа-Сеге с весом. Мы доказываем это неравенство для
монотонной и симметричной перестановки.
...
\begin{center}
\bf
A generalization of the P\'olya-Szeg\"o inequality for \\ one-dimensional functionals

S.~V.~Bankevich \qquad A.~I.~Nazarov

Abstract
\end{center}

We consider the Polya-Szeg\"o type weighted inequality. We prove this
 inequality for monotone rearrangement and for Steiner's symmetrization.

{\bf Keywords:} rearrangements, Lavrentiev's phenomenon
\end{document}
