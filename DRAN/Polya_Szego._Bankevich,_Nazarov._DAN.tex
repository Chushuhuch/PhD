...
Мы рассматриваем неравенство типа Полиа-Сеге. Мы доказываем это неравенство для
монотонной перестановки и штейнеровской симметризации.

\bigskip
\begin{center}
\bf
On the Polya-Szeg\"o inequality generalization for\\ one-dimensional functionals
