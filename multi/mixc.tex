...
доказательства которых в многомерных случаях дословно совпадают с доказательствами в одномерном случае.
...
Действительно: для любых $(s, t)$ выполнено $a( 1 ) - a( s ) \le a( t ) - a( -1 + t - s )$.
...
\begin{rem}
\label{lanLin}
Заметим, что если $u(\cdot, -1) \equiv 0$, то утверждение леммы верно без условия четности веса.
