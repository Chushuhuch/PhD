...
{\bf 1.} If the inequality $(\ref{toprove})$ holds for a $F \in \mathfrak{F}$
...
\begin{rem}
\label{lanNec}
If you put $u(\cdot, -1) \equiv 0$, then the condition (\ref{almostConcave}) is necessary for the inequality (\ref{toprove}).
\end{rem}
