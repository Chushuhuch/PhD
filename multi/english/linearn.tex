...
\begin{lm}
Let the function $a(x', \cdot, u)$ is even and satisfies the condition $(\ref{almostConcave})$ для всех $(x', u)$.
Then, if $u$ --- a non-negative piecewise linear function, then $I( u ) \ge I( u^* )$.
\end{lm}
