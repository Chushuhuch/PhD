...
We give necessary and sufficient conditions for the Polya--Szeg\"o type inequality with variable exponent of summability.
...
The well-known Polya-Szeg\"o inequality for $u \in \Wf(-1, 1)$ reads
\begin{equation}
\label{PS}
...
The article is divided into 6 sections. In Section 2 we deduce the necessary conditions for the Polya-Szeg\"o type inequalities.
