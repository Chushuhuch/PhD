...
\begin{rem}
If $a$ is admissible for $u$ the $b_{\ell}$ are obviously admissible too.
\end{rem}
...
is even in $x$, satisfies (\ref{almostConcave}) in correspondence with Lemma \ref{maxSumConcave},
